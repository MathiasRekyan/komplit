...
module.exports.run = async (Client, message, args, prefix) => {
    ...
    .addField("Passive Ability: Wolfish Tracker", "Increases ATK by 20/25/30/35/40%. On hit, attacks against enemies with less than 30% HP increase all party member's ATK by 40/50/60/70/80% for 12s. Can only occur once every 30s.") //change the Skill Name, And Skill description (passive ability)
