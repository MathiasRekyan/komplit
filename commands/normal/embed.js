...
module.exports.run = async (Client, message, args, prefix) => {
    ...
    .setURL('https://www.youtube.com/channel/UC_8BAnt6Fc0bgdl43H_Lz7g') // sets the URL for the title
    .setAuthor('Ars', message.author.displayAvatarURL()) // set the author with his avatar
