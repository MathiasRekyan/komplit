...
module.exports.run = async (Client, message, args, prefix) => {
    ...
    .setTitle("Dark Iron Sword")
    .addField("\u200B", "⧫ Type: " + "Sword" + "\r\n ⧫ Rarity: " + "⭐⭐⭐" + "\r\n ⧫ Location: " + "Gacha" , true)
    .addField("\u200B", "⧫ ATK: " + "39 (max 401)" + "\r\n ⧫ 2nd Stat: " + "Elemental Mastery 31(141)", true)
    ...
    .setImage("https://rerollcdn.com/GENSHIN/Weapon/NEW/Dark_Iron_Sword.png", 2, 2)
